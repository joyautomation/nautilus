...
// It is the engine behind `naut eip import`.
package codegen
...
func renderTypesST(m eip.Manifest, opts Options) (string, error) {
	var sb strings.Builder
	fmt.Fprintf(&sb, "(*\n  Generated by `naut eip import` from %s (slot %d).\n", opts.Host, opts.Slot)
...
func renderManifestGo(m eip.Manifest, opts Options) string {
	var sb strings.Builder
	fmt.Fprintf(&sb, "// Code generated by `naut eip import` from %s (slot %d). DO NOT EDIT.\n", opts.Host, opts.Slot)
