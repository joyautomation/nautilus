...
```yaml
# Generated by `nautilus sparkplug import --broker tcp://mqtt.riverbend:1883 --group RiverbendWTP`
...
```yaml
# Generated by `nautilus sparkplug import` from births on tcp://mqtt.riverbend:1883
