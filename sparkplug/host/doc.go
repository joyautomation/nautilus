...
// broker, presents their metrics as naut tags, sends operator writes back
...
// `naut sparkplug import`, mirroring the eip driver end to end. The
...
// `naut build`, i.e. in CI with no broker, so the driver is constructed
